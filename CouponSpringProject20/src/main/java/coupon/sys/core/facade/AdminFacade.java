...
public class AdminFacade implements CouponClientFacade {
	...
	public Company getCompany(String compName) throws CouponSystemException {
		...
		// get company with by name
		tmpComp = compDao.getCompany(compName);
		// check if we there is a company to show , if no throw exception
		if (tmpComp == null) {
			throw new CouponSystemException("There is no such company");
		}
	...
	public void createCustomer(Customer customer) throws CouponSystemException {
		...
		if (custDao.getCustomer(customer.getName()) == null && customer.getPassword()!="") {
