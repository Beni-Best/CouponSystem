...
/**
 * Login , Checks if User Name , Password and User Type currect. If currect redirect to the relevant page and set relevant facade to session
 * 
 *
 */
@Controller
...
//				request.getSession().setAttribute("UT", usertype);
