...
//		try {
			...
			if (tmpCoupon.getAmount() == 0) {
				throw new CouponSystemException("Sorry this coupon is out of stock");
			}
...
//		}
	...
	public Collection<Coupon> getAllCouponsByType(CouponType coupType) throws CouponSystemException {
		
		System.out.println(coupType);
		Collection<Coupon> tmpCoupons = new ArrayList<>();
		Collection<Coupon> coupons = new ArrayList<>();
